...
urlpatterns = [
    ...
    path("ingredients/<int:ingredient_id>/dishes/", DishListByIngredientView.as_view(), name='dish-list-by-ingredient'),
    path("types/<int:type_id>/dishes/", DishListByTypeView.as_view(), name='dish-list-by-type'),
